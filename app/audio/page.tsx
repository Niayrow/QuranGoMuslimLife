...
import { PlayCircle, Sparkles, Music, Play } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import StarrySky from "@/components/StarrySky"; // Import du composant partagé

export default function AudioPage() {
    return (
        <div className="min-h-screen text-white relative">

            {/* Fond Nuit Étoilée (Composant partagé) */}
            <StarrySky />
